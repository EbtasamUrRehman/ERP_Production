                    ...
                    try
                    {
                        ...
                        if (PrdLine.EditValue != null && Convert.ToInt32(PrdLine.EditValue) > 0)
                        {
                            if (partialQty < balance)
                            {
                                ...
                                tbl_Multi_PO_PlanTableAdapter.Insert(maxPID.Value, clientId, modelId, artId, LAName, (int)PrdLine.EditValue, DateTime.Now, custReqDate, ExFactoryDate, null, SecondConfDate, LastEditDate, DateTime.Now.Date, null, null, planDate, factoryCode, totalPlanQty, null, null, artSize,PlantCode);
            ...
            if (gridView.SelectedRowsCount > 0)
            {
                ...
                if (selectedRowHandle >= 0)
                {
                    try
                    {
                        ...
                        int v = tbl_Multi_PO_ReqTableAdapter.Insert(
                            DateTime.Now, MPID, PrdLine, PlanType, ReqFormula, RecQty, ExfactoryDate, null, secondConDate, null, null, null,
                            LpDate, creationDate, MatNumber, null, null, null, null, null, null, null, null, null, null, null, Unit, null, null, L4Name,
                            null, null, null, null, null, null, ArtID, artSize, RecQty
                        );
