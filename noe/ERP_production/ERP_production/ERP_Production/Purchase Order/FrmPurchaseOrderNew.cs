...
namespace ERP_Production.Purchase_Order
{
    public partial class FrmPurchaseOrderNew : Form
    {
        ...
        private void FrmPurchaseOrderNew_Load(object sender, EventArgs e)
        {
            ...
            this.tbl_Multi_PO_HTableAdapter.Fill(this.dSPurchaseOrderNew.tbl_Multi_PO_H, Convert.ToInt32(ClientNameComboBox.SelectedValue));
        ...
        {
            var gridView = (DevExpress.XtraGrid.Views.Grid.GridView3)GridControl1.FocusedView;
