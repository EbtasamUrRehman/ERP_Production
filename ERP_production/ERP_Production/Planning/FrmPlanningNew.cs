...
{
    public partial class FrmPlanningNew : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void FrmPlanningNew_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'dSPlanning1.Tbl_Multi_PO_Plan_D' table. You can move, or remove it, as needed.
            try
            {
                //this.tbl_Multi_PO_Plan_DTableAdapter.Fill(this.dSPlanning1.Tbl_Multi_PO_Plan_D);
            }
            catch
            {
            ...
            //// TODO: This line of code loads data into the 'dSPlanning1.tbl_Multi_PO_Plan' table. You can move, or remove it, as needed.
            //this.tbl_Multi_PO_PlanTableAdapter.Fill(this.dSPlanning1.tbl_Multi_PO_Plan);
            //// TODO: This line of code loads data into the 'dSPlanning1.tbl_Pro_Plan_D_Multiline' table. You can move, or remove it, as needed.
            //this.tbl_Pro_Plan_D_MultilineTableAdapter.Fill(this.dSPlanning1.tbl_Pro_Plan_D_Multiline);
            //// TODO: This line of code loads data into the 'dSPlanning1.tbl_Pro_Plan_Multiplan' table. You can move, or remove it, as needed.
            //this.tbl_Pro_Plan_MultiplanTableAdapter.Fill(this.dSPlanning1.tbl_Pro_Plan_Multiplan);
            // TODO: This line of code loads data into the 'dSPlanning1.View_Multi_po_planning' table. You can move, or remove it, as needed.
                    ...
                    try
                    {
                        ...
                        if (partialQty < balance)
                        {
                            ...
                            try
                            {
                                ...
                                this.view_Multi_po_planningTableAdapter.Fill(this.dSPlanning1.View_Multi_po_planning);
                            }
                            catch (Exception ex)
                            {
        ...
        private void FrmPlanningNew_Load_1(object sender, EventArgs e)
        {
